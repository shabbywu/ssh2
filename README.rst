...
本项目使用 `poetry <https://python-poetry.org/>`_ 管理依赖和打包, 目前该项目以发布至 pypi.org, 你可以从 pypi.org 安装该依赖或者选择从源码进行安装。
...
#. 使用(demo)
   :raw-html-m2r:`<code class="docutils literal"><span class="pre">&#96;&#96;yml
   # file</span></code>`\ demo.yml`
...
1. 请根据 `官方文档 <https://python-poetry.org/docs/#installation>`_ 安装 poetry
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
